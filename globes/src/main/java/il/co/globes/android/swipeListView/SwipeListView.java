...
package il.co.globes.android.swipeListView;
...
public class SwipeListView extends ListView
{
	...
	private CopyOfSwipeListViewListener CopyswipeListViewListener;
...
//			swipeOpenOnLongPress = styled.getBoolean(R.styleable.SwipeListView_swipeOpenOnLongPress, true);
	...
	protected void onClickFrontView(int position)
	{
		...
		if (CopyswipeListViewListener != null && position != ListView.INVALID_POSITION)
		{
			CopyswipeListViewListener.onClickFrontView(position);
		}
	...
	public void setSwipeListViewListener(CopyOfSwipeListViewListener copyOfSwipeListViewListener)
	{

		this.CopyswipeListViewListener = copyOfSwipeListViewListener;
	}
