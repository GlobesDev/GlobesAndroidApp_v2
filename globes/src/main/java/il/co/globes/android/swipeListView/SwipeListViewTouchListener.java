...
public class SwipeListViewTouchListener implements View.OnTouchListener
{
	...
	protected void openAnimate(int position)
	{
		...
		if (v != null)
		{
			openAnimate(v.findViewById(swipeFrontView), position);
		}
		else 
		{
			Log.e("eli", "view was null - in openAnimate");
		}
	}
	...
	protected void closeAnimate(int position)
	{
		...
		{
			Log.e("eli", "view was null - in closeAnimate");
		}
	}
	...
	// }
	//
	// animate(view).translationX(moveTo).setDuration(animationTime).setListener(new
