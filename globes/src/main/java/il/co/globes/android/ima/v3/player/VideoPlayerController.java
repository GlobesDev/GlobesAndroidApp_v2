...
import static com.google.ads.interactivemedia.v3.api.AdEvent.AdEventType.ALL_ADS_COMPLETED;
...
public class VideoPlayerController implements AdErrorEvent.AdErrorListener,
    ...
    public VideoPlayerController(Context context, VideoPlayer videoPlayer,
        ...
        mDefaultAdTagUrl = Definitions.AdsIMAPreRollUrl; //Definitions.AdsPreRollUrl;
        
        //mDefaultAdTagUrl = "http://binny1989.github.io/Skipadtag.xml";
        ...
        //"http://binny1989.github.io/Skipadtag.xml";
    ...
    public void onAdEvent(AdEvent adEvent) {
       ...
       // Log.e("alex", "WWW: SampleVideoPlayer start()");
        ...
        switch (adEvent.getType()) {
        	case STARTED:
        		Log.e("alex", "IIIIIIIIIIIIIIIIIIIII");        		        		
        		break;
            case LOADED:
